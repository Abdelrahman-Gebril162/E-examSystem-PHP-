<?php include "../../../functions/faculty/facultyDepartment.php"?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="<?php echo $row["logo"];?>" alt="logo"></p>
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center ">
                                    ...
                                    <p class="card-text">Department : <?php echo $row["name"];?></p>
                                    <p class="card-text">Faculty : <?php echo $row["ffname"];?></p>
            ...
            <?php } ?>
         <?php } ?>
        <?php if($res==null){echo "<h1 style='text-align:center;color:red;line-height:400px;transform: skewY(20deg);'> There is No Department Created Yet.</h1>" ;}?>
