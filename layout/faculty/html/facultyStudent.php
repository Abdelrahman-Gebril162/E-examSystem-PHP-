<?php include "../../../functions/faculty/facultyStudent.php"?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            ...
            <a class="nav-link" href="../../../layout/faculty/html/Details.php?id=<?php if($res != null){echo $res[0]["faculty_id"];}else{extract($_GET);echo $id;}?>">
                <img src="<?php echo $dd[0]["logo"];?>" alt="faculty LoGo" style="width:100px;height:100px;border-radius:50%;">
                <a>
            </div>
        ...
        <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                            ...
                            <li class="nav-item"><a class="nav-link" href="../../../layout/faculty/html/Details.php?id=<?php if($res != null){echo $res[0]["faculty_id"];}else{extract($_GET);echo $id;}?>"><?php if($res != null){echo $res[0]["ffname"];}else{echo "MyFaculty";}?></a></li>
                        </ul>
                    </div>
                </div>
            </nav>
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="<?php echo $res[$i]["picture"];?>" alt="card image"></p>
                                    <h4 class="card-title"><?php echo $res[$i]["fname"]." ".$res[$i]["lname"];?></h4>
                                    Hover 
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center ">
                                    ...
                                    <p class="card-text">Your Faculty : <?php echo $res[$i]["ffname"];?></p>
                                    <p class="card-text">Your Department : <?php echo $res[$i]["ddname"];?></p>
                                    <p class="card-text">National Id  : <?php echo $res[$i]["N_id"];?></p>
                                    <p class="card-text">BirthDay : <?php echo $res[$i]["birthdate"];?></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            ?>
         <?php } ?>
         <?php if($res==null){echo "<h1 style='text-align:center;color:red;line-height:400px;transform: skewY(20deg);'> There is No Student Created Yet.</h1>" ;}?>
            </div>
            </div>
        </div>
    </div>
